...
export default function AboutPage() {
  return (
    <div className="text-lg leading-relaxed">
      ...
      <p className="mb-10">
        AIDA-X Cloud is the deticaded space for new and free models{" "}
        <a
          href="https://www.aida-x.cc/"
      ...
      <h3 className="text-3xl font-satoshi-medium pb-10">A Direct Fork of ToneHunt</h3>

      <p className="pb-10">
        AIDA-X Cloud is based on ToneHunt. It is a collaborative effort by many people passionate about music, open
        source, people and software. There are many collaborators that are making ToneHunt possible. We will soon have a
        list here that will include everyone who has ever contributed to ToneHunt.
      </p>

      <p className="pb-10">
        Since AIDA-X and ToneHunt are an open initiative, you can find all the technology used to build the platform in
        their{" "}
        <a
      ...
      <p className="pb-5">
        In the spirit of AIDA-X and ToneHunt open source philosophy, our aim at AIDA-X is to add value to the life of
        the musician/products/engineer under the guidance of the following values:
      </p>
